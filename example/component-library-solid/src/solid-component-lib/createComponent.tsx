...
const createComponent = <ElementType extends HTMLStencilElement>(
  ...
  if (props.children) {
    if (Array.isArray(props.children)) {
      ...
      children = [createComponent(_h, tagName, fixNode(props.children))];
    }
  }
...
function fixNode(children: Node): StencilSolidInternalProps<HTMLStencilElement> {
  return {
    ...children,
    textContent: children.textContent ?? undefined,
  };
}
