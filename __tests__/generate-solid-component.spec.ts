...
import {PackageJSON, OutputTargetSolid} from '../src';
...
describe('createComponentDefinition', () => {
  it('should create a Solid component with custom element support', () => {
    ...
    expect(output[0]).toEqual(`export const MyComponent = /*@__PURE__*/createSolidComponent<JSX.MyComponent, HTMLMyComponentElement>('my-component', undefined, undefined, defineMyComponent);`);
  });
  ...
  it('should create a Solid component without custom element support', () => {
    ...
    expect(output[0]).toEqual(`export const MyComponent = /*@__PURE__*/createSolidComponent<JSX.MyComponent, HTMLMyComponentElement>('my-component');`);
  });
});
