...
const getPathToCorePackageLoader = (config, outputTarget) => {
    ...
    const distAbsEsmLoaderPath = (distOutputTarget === null || distOutputTarget === void 0 ? void 0 : distOutputTarget.esmLoaderPath) && path__namespace.isAbsolute(distOutputTarget.esmLoaderPath)
        ? distOutputTarget.esmLoaderPath
        : null;
    const distRelEsmLoaderPath = config.rootDir && distAbsEsmLoaderPath
        ? path__namespace.relative(config.rootDir, distAbsEsmLoaderPath)
        : null;
...
const copyResources = async (config, outputTarget) => {
    ...
    const srcDirectory = path__namespace.join(__dirname, '..', 'src', 'solid-component-lib');
